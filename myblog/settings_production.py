...
CACHES = {
    ...
    'sessions': {
        'BACKEND': 'django.core.cache.backends.redis.RedisCache',
        'LOCATION': os.environ.get('REDIS_URL', 'redis://localhost:6379/0') + '/1',
        'KEY_PREFIX': 'sessions',
    ...
    'api_cache': {
        'BACKEND': 'django.core.cache.backends.redis.RedisCache',
        'LOCATION': os.environ.get('REDIS_URL', 'redis://localhost:6379/0') + '/2',
        'KEY_PREFIX': 'api',
    ...
    'static_cache': {
        'BACKEND': 'django.core.cache.backends.redis.RedisCache',
        'LOCATION': os.environ.get('REDIS_URL', 'redis://localhost:6379/0') + '/3',
        'KEY_PREFIX': 'static',
...
CHANNEL_LAYERS = {
    'default': {
        ...
        'CONFIG': {
            'hosts': [os.environ.get('REDIS_URL', 'redis://localhost:6379/0') + '/4'],
            'capacity': 1500,
            'expiry': 10,
        },
    },
